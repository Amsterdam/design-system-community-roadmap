import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n}from"./iframe-B3vUvLnX.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{D as i,E as a,M as o,N as s,O as c,P as l,f as u,j as d,m as f,t as p,w as m}from"./src-D7JmjxSY.js";import{a as h,d as g,f as _,n as v,o as y,s as b,t as x,u as S}from"./StrapiImageBlock-pfhqznT2.js";import{n as C,t as w}from"./date-BtMdw1fv.js";var T,E=e((()=>{T={"feature-detail__stories-container":`_feature-detail__stories-container_cbgs1_1`,"feature-detail__stories":`_feature-detail__stories_cbgs1_1`,"feature-detail__story-content":`_feature-detail__story-content_cbgs1_9`,"feature-detail__story-date":`_feature-detail__story-date_cbgs1_16`,"feature-detail__details":`_feature-detail__details_cbgs1_20`,"feature-detail__header":`_feature-detail__header_cbgs1_33`}}));function D({title:e,content:t,currentUserDocumentId:n,endDate:r,images:l,isLiked:p,reactions:g,startDate:v,stories:y,storyDocumentId:b,voteCount:C}){let E=_(),[D,A]=(0,O.useState)(!1),[j,M]=(0,O.useState)(),N=[...y].sort((e,t)=>!e.startDate&&!t.startDate?0:e.startDate?t.startDate?new Date(e.startDate).getTime()-new Date(t.startDate).getTime():-1:1);return(0,k.jsxs)(i,{gapVertical:`large`,children:[(0,k.jsxs)(i.Cell,{className:`ams-prose`,span:{narrow:4,medium:8,wide:7},children:[(0,k.jsxs)(`div`,{className:T[`feature-detail__header`],children:[(0,k.jsx)(c,{level:1,size:`level-2`,children:e}),(0,k.jsx)(m,{count:C,isLiked:p,onToggle:async e=>{if(!n){E.push(`/inloggen`);return}if((await S(b,e)).needsLogin){E.push(`/inloggen`);return}E.refresh()},size:`large`})]}),(0,k.jsx)(d,{children:t}),(0,k.jsx)(x,{fallbackAlt:e,images:l}),y.length>0&&(0,k.jsxs)(`div`,{className:T[`feature-detail__stories-container`],children:[(0,k.jsx)(c,{level:2,size:`level-4`,children:`Stories`}),(0,k.jsx)(`div`,{className:T[`feature-detail__stories`],children:(0,k.jsx)(o,{headingLevel:3,children:N.map(e=>(0,k.jsx)(o.Step,{heading:e.title,children:(0,k.jsxs)(`div`,{className:T[`feature-detail__story-content`],children:[(0,k.jsx)(`div`,{className:T[`feature-detail__story-date`],children:(0,k.jsx)(a,{label:w(e.startDate,e.endDate)})}),(0,k.jsx)(s,{href:`/stories/${e.documentId}`,children:`Bekijk details`})]})},e.documentId))})})]})]}),(0,k.jsxs)(i.Cell,{className:`ams-prose`,span:{narrow:4,medium:8,wide:5},children:[(0,k.jsx)(c,{level:2,size:`level-4`,children:`Details`}),(0,k.jsxs)(`dl`,{className:T[`feature-detail__details`],children:[(0,k.jsx)(`dt`,{children:(0,k.jsx)(`strong`,{children:`Status`})}),(0,k.jsx)(`dd`,{children:(0,k.jsx)(a,{color:r&&new Date(r)<new Date?`lime`:`azure`,label:r&&new Date(r)<new Date?`Voltooid`:`In uitvoering`})}),(0,k.jsx)(`dt`,{children:(0,k.jsx)(`strong`,{children:`Startdatum`})}),(0,k.jsx)(`dd`,{children:v?new Date(v).toLocaleDateString(`nl-NL`):`Onbekend`}),r&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`dt`,{children:(0,k.jsx)(`strong`,{children:`Einddatum`})}),(0,k.jsx)(`dd`,{children:new Date(r).toLocaleDateString(`nl-NL`)})]})]}),(0,k.jsx)(c,{level:2,size:`level-4`,children:`Reacties`}),(0,k.jsx)(u,{compact:!0,reactions:g}),(0,k.jsx)(f,{error:j,isLoggedIn:!!n,loading:D,onSubmit:async e=>{A(!0),M(void 0);let t=await h(b,e);if(A(!1),t.needsLogin){E.push(`/inloggen`);return}if(t.error){M(t.error);return}t.success&&E.refresh()}})]})]})}var O,k,A=e((()=>{l(),p(),g(),O=t(n()),b(),y(),C(),E(),v(),k=r(),D.__docgenInfo={description:``,methods:[],displayName:`FeatureDetail`,props:{content:{required:!0,tsType:{name:`string`},description:``},currentUserDocumentId:{required:!1,tsType:{name:`string`},description:``},endDate:{required:!1,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},images:{required:!1,tsType:{name:`union`,raw:`StrapiImage[] | null`,elements:[{name:`Array`,elements:[{name:`StrapiImage`}],raw:`StrapiImage[]`},{name:`null`}]},description:``},isLiked:{required:!0,tsType:{name:`boolean`},description:``},reactions:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{

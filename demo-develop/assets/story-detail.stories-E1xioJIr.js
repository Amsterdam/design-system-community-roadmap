import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n}from"./iframe-Bnt7t73V.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{E as i,f as a,m as o,t as s}from"./src-Bgs4uQLm.js";import{a as c,d as l,f as u,g as d,h as f,m as p,n as m,o as h,p as g,s as _,t as v,u as y,v as b,y as x}from"./StrapiImageBlock-DVeLhcmX.js";var S,C=e((()=>{S={"story-detail__features-container":`_story-detail__features-container_d1vs3_1`,"story-detail__features":`_story-detail__features_d1vs3_1`,"story-detail__feature-content":`_story-detail__feature-content_d1vs3_9`,"story-detail__feature-date":`_story-detail__feature-date_d1vs3_16`,"story-detail__details":`_story-detail__details_d1vs3_20`,"story-detail__header":`_story-detail__header_d1vs3_33`}}));function w({title:e,content:t,currentUserDocumentId:n,endDate:r,features:s,images:l,isLiked:m,reactions:h,startDate:_,storyDocumentId:x,voteCount:C}){let w=u(),[D,O]=(0,T.useState)(!1),[k,A]=(0,T.useState)(),j=[...s].sort((e,t)=>!e.startDate&&!t.startDate?0:e.startDate?t.startDate?new Date(e.startDate).getTime()-new Date(t.startDate).getTime():-1:1);return(0,E.jsxs)(p,{gapVertical:`large`,children:[(0,E.jsxs)(p.Cell,{className:`ams-prose`,span:{narrow:4,medium:8,wide:7},children:[(0,E.jsxs)(`div`,{className:S[`story-detail__header`],children:[(0,E.jsx)(f,{level:1,size:`level-2`,children:e}),(0,E.jsx)(i,{count:C,isLiked:m,onToggle:async e=>{if(!n){w.push(`/inloggen`);return}if((await y(x,e)).needsLogin){w.push(`/inloggen`);return}w.refresh()},size:`large`})]}),(0,E.jsx)(d,{children:t}),(0,E.jsx)(v,{fallbackAlt:e,images:l}),s.length>0&&(0,E.jsxs)(`div`,{className:S[`story-detail__features-container`],children:[(0,E.jsx)(f,{level:2,size:`level-4`,children:`Features`}),(0,E.jsx)(`div`,{className:S[`story-detail__features`],children:j.map(e=>(0,E.jsx)(`span`,{children:(0,E.jsxs)(`div`,{className:S[`story-detail__feature-content`],children:[(0,E.jsx)(f,{level:4,children:e.title}),(0,E.jsx)(b,{href:`/features/${e.documentId}`,children:`Bekijk details`})]})},e.documentId))})]})]}),(0,E.jsxs)(p.Cell,{className:`ams-prose`,span:{narrow:4,medium:8,wide:5},children:[(0,E.jsx)(f,{level:2,size:`level-4`,children:`Details`}),(0,E.jsxs)(`dl`,{className:S[`story-detail__details`],children:[(0,E.jsx)(`dt`,{children:(0,E.jsx)(`strong`,{children:`Status`})}),(0,E.jsx)(`dd`,{children:(0,E.jsx)(g,{color:r&&new Date(r)<new Date?`lime`:`azure`,label:r&&new Date(r)<new Date?`Voltooid`:`In uitvoering`})}),(0,E.jsx)(`dt`,{children:(0,E.jsx)(`strong`,{children:`Startdatum`})}),(0,E.jsx)(`dd`,{children:_?new Date(_).toLocaleDateString(`nl-NL`):`Onbekend`}),r&&(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(`dt`,{children:(0,E.jsx)(`strong`,{children:`Einddatum`})}),(0,E.jsx)(`dd`,{children:new Date(r).toLocaleDateString(`nl-NL`)})]})]}),(0,E.jsx)(f,{level:2,size:`level-4`,children:`Reacties`}),(0,E.jsx)(a,{compact:!0,reactions:h}),(0,E.jsx)(o,{error:k,isLoggedIn:!!n,loading:D,onSubmit:async e=>{O(!0),A(void 0);let t=await c(x,e);if(O(!1),t.needsLogin){w.push(`/inloggen`);return}if(t.error){A(t.error);return}t.success&&w.refresh()}})]})]})}var T,E,D=e((()=>{x(),s(),l(),T=t(n()),_(),h(),C(),m(),E=r(),w.__docgenInfo={description:``,methods:[],displayName:`StoryDetail`,props:{content:{required:!0,tsType:{name:`string`},description:``},currentUserDocumentId:{required:!1,tsType:{name:`string`},description:``},endDate:{required:!1,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},features:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  documentId: string
  endDate?: string | null
  startDate?: string
  title: string

import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n}from"./iframe-rU27AwW9.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{A as i,E as a,F as o,I as s,N as c,O as l,P as u,f as d,k as f,m as p,t as m}from"./src-3_FeW3QI.js";import{c as h,d as g,f as _,n as v,o as y,r as b,s as x,t as S}from"./StrapiImageBlock-CDFp6lOc.js";import{n as C,t as w}from"./date-BtMdw1fv.js";var T,E=e((()=>{T={"feature-detail__stories-container":`_feature-detail__stories-container_cbgs1_1`,"feature-detail__stories":`_feature-detail__stories_cbgs1_1`,"feature-detail__story-content":`_feature-detail__story-content_cbgs1_9`,"feature-detail__story-date":`_feature-detail__story-date_cbgs1_16`,"feature-detail__details":`_feature-detail__details_cbgs1_20`,"feature-detail__header":`_feature-detail__header_cbgs1_33`}}));function D({title:e,content:t,currentUserDocumentId:n,endDate:r,featureDocumentId:s,images:m,isLiked:g,reactions:v,startDate:y,stories:x,voteCount:C}){let E=_(),[D,A]=(0,O.useState)(!1),[j,M]=(0,O.useState)(),N=[...x].sort((e,t)=>!e.startDate&&!t.startDate?0:e.startDate?t.startDate?new Date(e.startDate).getTime()-new Date(t.startDate).getTime():-1:1);return(0,k.jsxs)(f,{gapVertical:`large`,children:[(0,k.jsxs)(f.Cell,{className:`ams-prose`,span:{narrow:4,medium:8,wide:7},children:[(0,k.jsxs)(`div`,{className:T[`feature-detail__header`],children:[(0,k.jsx)(i,{level:1,size:`level-2`,children:e}),(0,k.jsx)(a,{count:C,isLiked:g,onToggle:async e=>{if(!n){E.push(`/inloggen`);return}if((await h(s,e)).needsLogin){E.push(`/inloggen`);return}E.refresh()},size:`large`})]}),(0,k.jsx)(c,{children:t}),(0,k.jsx)(S,{fallbackAlt:e,images:m}),x.length>0&&(0,k.jsxs)(`div`,{className:T[`feature-detail__stories-container`],children:[(0,k.jsx)(i,{level:2,size:`level-4`,children:`Stories`}),(0,k.jsx)(`div`,{className:T[`feature-detail__stories`],children:(0,k.jsx)(u,{headingLevel:3,children:N.map(e=>(0,k.jsx)(u.Step,{heading:e.title,children:(0,k.jsxs)(`div`,{className:T[`feature-detail__story-content`],children:[(0,k.jsx)(`div`,{className:T[`feature-detail__story-date`],children:(0,k.jsx)(l,{label:w(e.startDate,e.endDate)})}),(0,k.jsx)(o,{href:`/stories/${e.documentId}`,children:`Bekijk details`})]})},e.documentId))})})]})]}),(0,k.jsxs)(f.Cell,{className:`ams-prose`,span:{narrow:4,medium:8,wide:5},children:[(0,k.jsx)(i,{level:2,size:`level-4`,children:`Details`}),(0,k.jsxs)(`dl`,{className:T[`feature-detail__details`],children:[(0,k.jsx)(`dt`,{children:(0,k.jsx)(`strong`,{children:`Status`})}),(0,k.jsx)(`dd`,{children:(0,k.jsx)(l,{color:r&&new Date(r)<new Date?`lime`:`azure`,label:r&&new Date(r)<new Date?`Voltooid`:`In uitvoering`})}),(0,k.jsx)(`dt`,{children:(0,k.jsx)(`strong`,{children:`Startdatum`})}),(0,k.jsx)(`dd`,{children:y?new Date(y).toLocaleDateString(`nl-NL`):`Onbekend`}),r&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`dt`,{children:(0,k.jsx)(`strong`,{children:`Einddatum`})}),(0,k.jsx)(`dd`,{children:new Date(r).toLocaleDateString(`nl-NL`)})]})]}),(0,k.jsx)(i,{level:2,size:`level-4`,children:`Reacties`}),(0,k.jsx)(d,{compact:!0,reactions:v}),(0,k.jsx)(p,{error:j,isLoggedIn:!!n,loading:D,onSubmit:async e=>{A(!0),M(void 0);let t=await b(s,e);if(A(!1),t.needsLogin){E.push(`/inloggen`);return}if(t.error){M(t.error);return}t.success&&E.refresh()}})]})]})}var O,k,A=e((()=>{s(),m(),g(),O=t(n()),x(),y(),C(),E(),v(),k=r(),D.__docgenInfo={description:``,methods:[],displayName:`FeatureDetail`,props:{content:{required:!0,tsType:{name:`string`},description:``},currentUserDocumentId:{required:!1,tsType:{name:`string`},description:``},endDate:{required:!1,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},featureDocumentId:{required:!0,tsType:{name:`string`},description:``},images:{required:!1,tsType:{name:`union`,raw:`StrapiImage[] | null`,elements:[{name:`Array`,elements:[{name:`StrapiImage`}],raw:`StrapiImage[]`},{name:`null`}]},description:``},isLiked:{required:!0,tsType:{name:`boolean`},description:``},reactions:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{

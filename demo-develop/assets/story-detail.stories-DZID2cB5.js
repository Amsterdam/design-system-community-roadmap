import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n}from"./iframe-B3vUvLnX.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{D as i,N as a,O as o,P as s,f as c,j as l,m as u,t as d,w as f}from"./src-D7JmjxSY.js";import{c as p,d as m,f as h,n as g,o as _,r as v,s as y,t as b}from"./StrapiImageBlock-pfhqznT2.js";var x,S=e((()=>{x={"story-detail__details":`_story-detail__details_1r95y_1`,"story-detail__header":`_story-detail__header_1r95y_14`}}));function C({title:e,content:t,currentUserDocumentId:n,endDate:r,featureDocumentId:s,images:d,isLiked:m,parentFeature:g,reactions:_,startDate:y,voteCount:S}){let C=h(),[E,D]=(0,w.useState)(!1),[O,k]=(0,w.useState)();return(0,T.jsxs)(i,{gapVertical:`large`,children:[(0,T.jsxs)(i.Cell,{className:`ams-prose`,span:{narrow:4,medium:8,wide:7},children:[(0,T.jsxs)(`div`,{className:x[`story-detail__header`],children:[(0,T.jsx)(o,{level:1,size:`level-2`,children:e}),(0,T.jsx)(f,{count:S,isLiked:m,onToggle:async e=>{if(!n){C.push(`/inloggen`);return}if((await p(s,e)).needsLogin){C.push(`/inloggen`);return}C.refresh()},size:`large`})]}),(0,T.jsx)(l,{children:t}),(0,T.jsx)(b,{fallbackAlt:e,images:d})]}),(0,T.jsxs)(i.Cell,{className:`ams-prose`,span:{narrow:4,medium:8,wide:5},children:[g&&(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(o,{level:2,size:`level-4`,children:`Feature`}),(0,T.jsx)(a,{href:`/features/${g.documentId}`,children:g.title})]}),(0,T.jsx)(o,{level:2,size:`level-4`,children:`Details`}),(0,T.jsxs)(`dl`,{className:x[`story-detail__details`],children:[(0,T.jsx)(`dt`,{children:(0,T.jsx)(`strong`,{children:`Startdatum`})}),(0,T.jsx)(`dd`,{children:y?new Date(y).toLocaleDateString(`nl-NL`):`Onbekend`}),r&&(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(`dt`,{children:(0,T.jsx)(`strong`,{children:`Einddatum`})}),(0,T.jsx)(`dd`,{children:new Date(r).toLocaleDateString(`nl-NL`)})]})]}),(0,T.jsx)(o,{level:2,size:`level-4`,children:`Reacties`}),(0,T.jsx)(c,{compact:!0,reactions:_}),(0,T.jsx)(u,{error:O,isLoggedIn:!!n,loading:E,onSubmit:async e=>{D(!0),k(void 0);let t=await v(s,e);if(D(!1),t.needsLogin){C.push(`/inloggen`);return}if(t.error){k(t.error);return}t.success&&C.refresh()}})]})]})}var w,T,E=e((()=>{s(),d(),m(),w=t(n()),y(),_(),S(),g(),T=r(),C.__docgenInfo={description:``,methods:[],displayName:`StoryDetail`,props:{content:{required:!0,tsType:{name:`string`},description:``},currentUserDocumentId:{required:!1,tsType:{name:`string`},description:``},endDate:{required:!1,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},featureDocumentId:{required:!0,tsType:{name:`string`},description:``},images:{required:!1,tsType:{name:`union`,raw:`StrapiImage[] | null`,elements:[{name:`Array`,elements:[{name:`StrapiImage`}],raw:`StrapiImage[]`},{name:`null`}]},description:``},isLiked:{required:!0,tsType:{name:`boolean`},description:``},parentFeature:{required:!1,tsType:{name:`union`,raw:`ParentFeature | null`,elements:[{name:`signature`,type:`object`,raw:`{
  documentId: string
  title: string
